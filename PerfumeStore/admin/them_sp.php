...
<form method="post" action="" name="ThemSP" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-2"><strong>Loại rượu</strong></div>
        <div class="col-md-9">
            <?php
    ...
    <div class="row">
        ...
        <div class="col-md-9"><input type="number" id="Gia-Ban" name="GiaBan" oninput="validatePrice()" value="0"></div>
    </div>
    <div class="row">
        <div class="col-md-2"><strong>Giá khuyến mãi</strong></div>
        <div class="col-md-9"><input type="number" id="GiaKhuyenmai" name="GiaKhuyenmai" value="0" oninput="validatePrice()"></div>
    </div>
    <script>
    function validatePrice() {
        var giaBan = document.getElementById('Gia-Ban').value;
        var giaKhuyenmai = document.getElementById('GiaKhuyenmai').value;

        // Chuyển đổi giá trị nhập vào thành số để so sánh
        giaBan = parseFloat(giaBan);
        giaKhuyenmai = parseFloat(giaKhuyenmai);

        // Kiểm tra nếu giá khuyến mãi lớn hơn giá bán
        if (giaKhuyenmai > giaBan) {
            alert('Giá khuyến mãi không thể lớn hơn giá bán. Vui lòng nhập lại.');
            document.getElementById('GiaKhuyenmai').value = giaBan;
        }
    }
    </script>
    <div class="row">
        <div class="col-md-2"><strong>Số lượng trong kho</strong></div>
        <div class="col-md-9"><input type="number" id="SoLuongTonKho" min=0 name="SoLuongTonKho" value="0"></div>
    </div>
    <div class="row">
