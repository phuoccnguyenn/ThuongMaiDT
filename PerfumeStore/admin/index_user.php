...
$sl_user = "select * from users WHERE idGroup=2 or idGroup=5";
...
<div style="overflow-x: scroll"> <table class=" table table-bordered hover"  style="overflow-x: scroll" border="2">
        ...
        <?php while ($r = $rs_user->fetch_assoc()) {?>
            ...
            <td><a href="khoa_user.php?idUser=<?php echo $r['idUser'];?>" ><strong> Khóa </strong></a></td>
            <td><a href="mokhoa_user.php?idUser=<?php echo $r['idUser'];?>" ><strong> Mở </strong></a></td>
