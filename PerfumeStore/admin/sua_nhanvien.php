        ...
        if ($_POST['Username'] != "" &&$_POST['Password_old'] != "" && $_POST['Password'] != "" && $_POST['Password_1'] != "" && $_POST['DienThoai'] != "") {
            ...
            if ($thongbao != "") {
                ...
                if ($kq1) {
                    ...
                    echo "location.href='../admin/index_nv.php';</script>";
                }
            }
        }
        else
...
<!-- Nội dung ở đây -->
<h3 style="text-align: center">Sửa Nhân viên</h3>
<form method="post" action="" name="ThemUser" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-md-9" style="color: red;"><input style="border-radius: 5px; color: black;" type="text" name="Username" placeholder="ví dụ: abc" size="50" value="<?php echo isset($d['HoTen']);?>"/></div>
    </div>
    <div class="row">
        <div class="col-md-2"  style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><strong>Họ Tên Nhân viên:</strong></div>
        <div class="col-md-9" style="color: red;"><input style="border-radius: 5px; color: black;" type="text" name="HoTenK" placeholder="ví dụ: abc" size="50" value="<?php echo isset($d['HoTenK']);?>"/></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-9" style="color: red;"><input style="border-radius: 5px; color: black;" type="text" name="DiaChi" placeholder="Ví dụ: TpHCM, Quảng Ngãi" size="50" value="<?php echo isset($d['DiaChi']);?>"/></div>
    </div>
    <div class="row">
        <div class="col-md-2" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><strong>Điện thoại: </strong></div>
        <div class="col-md-9" style="color: red;"><input style="border-radius: 5px; color: black;" type="tel" name="DienThoai" placeholder="ví dụ: 0965555555" maxlength="13"size="50" value="<?php echo isset($d['DienThoai']);?> "/></div>
    </div>
    <div class="row">
        <div class="col-md-2" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><strong>Email: </strong></div>
        <div class="col-md-9" style="color: red;"><input style="border-radius: 5px; color: black;" type="email" name="Email" placeholder="ví dụ: abc@gmail.com" size="50" value="<?php echo isset($d['Email']);?>" /></div>
    </div>
    <div class="row">
        <div class="col-md-2" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"><strong>Ngày đăng ký: </strong></div>
        <div class="col-md-9"><input style="border-radius: 5px; color: black;" type="text" name="NgayDangKy" readonly="readonly" size="50" value="<?php echo isset($d["NgayDangKy"])?>"/></div>
    </div>
    <div class="row">
        <div class="col-md-2"></div>
        <div class="col-md-9"><button id="Sua" name="Sua"  class="btn btn-success">Sửa</button>   
        <button class="btn btn-success">
            <a style="text-decoration: none; color: #FFFFFF;" href="../admin/index_nhanvien.php">Thoát</a>
        </button> </div>
    </div>
