...
if(isset($_POST['Them'])) {
    if ($_POST['Username'] != "" && $_POST['Password'] != "" && $_POST['Password_1'] != ""&& $_POST['DienThoai'] != "") {
        ...
        if ($thongbao != "") {
            ...
            $sl = "insert into Users(HoTen,HoTenK,Password,DiaChi,DienThoai,Email,NgayDangKy,idGroup) VALUES ('" . $_POST['Username'] . "','" . $_POST['HoTenK'] . "','" . md5($_POST['Password']) . "','" . $_POST['DiaChi'] . "','" . $_POST['DienThoai'] . "','" . $_POST['Email'] . "','" . $_POST['NgayDangKy'] . "',4)";
...
<!-- Nội dung ở đây -->
<h3 style="text-align: center">Thêm Nhân viên</h3>
<form method="post" action="" name="ThemUser" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
        <button id="Them" name="Them"  class="btn btn-success">Thêm TK</button>  
