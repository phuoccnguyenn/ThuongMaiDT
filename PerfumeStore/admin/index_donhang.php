...
$sl_donhang = "SELECT dh.*, dhct.TenSP
               FROM donhang dh
               LEFT JOIN donhangchitiet dhct ON dh.idDH = dhct.idDH
...
<div style="overflow-x: scroll">
    <table class=" table table-bordered hover" style="overflow-x: scroll" border="2">
        ...
        while ($r = $rs_donhang->fetch_assoc()) { ?>
            ...
            <td>
                <a href="index_ds_chitietdh.php?idDH=<?php echo $r['idDH']; ?>"><strong><?php echo $r['TenSP']; ?></strong></a>
            </td>
            ...
            <td><a href="sua_donhang.php?idKM=<?php echo $r['idDH'];?>" ><strong> SỬA </strong></a></td>
