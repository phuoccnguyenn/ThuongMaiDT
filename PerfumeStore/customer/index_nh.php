...
<!--Content Start Here -->
<h3 style="text-align: center">DANH SÁCH CÁC NHÃN HIỆU CỦA RƯỢU</h3>
...
<table class=" table table-bordered " border="2">
    ...
    <tr>
        ...
        <td width="50%"><strong> TÊN NHÃN HIỆU RƯỢU </strong></td>
        <td width="10%"><strong> TÊN LOẠI RƯỢU </strong></td>
