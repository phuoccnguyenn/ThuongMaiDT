        ...
        if ($_POST['Username'] != "" &&$_POST['Password_old'] != "" && $_POST['Password'] != "" && $_POST['Password_1'] != "" && $_POST['DienThoai'] != "") {
            ...
            if ($thongbao != "") {
                ...
                if ($kq1) {
                    ...
                    echo "location.href='../customer/index_user.php';</script>";
                }
            }
        }
        else
...
<!-- Nội dung ở đây -->
<h3 style="text-align: center">Sửa User</h3>
<form method="post" action="" name="ThemUser" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <button class="btn btn-success">
            <a style="text-decoration: none; color: #FFFFFF;" href="../customer/index_user.php">Thoát</a>
        </button> </div>
    </div>
