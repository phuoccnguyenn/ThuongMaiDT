...
<form method="post" action="" name="sua_km" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-9"><button id="Sua" name="Sua"  class="btn btn-success">Sửa KM</button>  <button class="btn btn-success"><a style="text-decoration: none; color: #FFFFFF;" href="../customer/KhuyenMai.php">Thoát</a></button></div>
    </div>
</form>
