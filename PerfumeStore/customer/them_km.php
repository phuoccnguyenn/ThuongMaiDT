...
if(isset($_POST['Them'])) {
    ...
    if ($kq_km) {
        ...
        echo "location.href='../customer/KhuyenMai.php';</script>";
    }
}
?>
<!DOCTYPE html>
...
<form method="post" action="" name="them_km" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-9"><button id="Them" name="Them"  class="btn btn-success">Thêm KM</button>  <button class="btn btn-success"><a style="text-decoration: none; color: #FFFFFF;" href="../customer/KhuyenMai.php">Thoát</a></button></div>
    </div>
</form>
